#!/bin/bash
# update_frontend_flavia.sh - Build flavia-app Docker image for registry upload

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
APP_DIR="$SCRIPT_DIR/flavia-app"
...
IMAGE_NAME="${IMAGE_NAME:-${REGISTRY_HOST}/gian/flavia-frontend}"
