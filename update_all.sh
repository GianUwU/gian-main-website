...
echo ""
echo "🌐 [2/5] Updating Main Frontend..."
echo "------------------------------------------"
"$(dirname "$0")/update_frontend_main.sh"

echo ""
echo "📂 [3/5] Updating Drop Frontend..."
echo "------------------------------------------"
"$(dirname "$0")/update_frontend_drop.sh"

echo ""
echo "💰 [4/5] Updating Finance Frontend..."
echo "------------------------------------------"
"$(dirname "$0")/update_frontend_finance.sh"

echo ""
echo "👱 [5/5] Updating Flavia Frontend..."
echo "------------------------------------------"
...
echo "✅ Drop Frontend (drop.gian.ink): Updated"
