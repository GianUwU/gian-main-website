#!/bin/bash
# update_frontend_finance.sh - Build finance-app Docker image for registry upload

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
APP_DIR="$SCRIPT_DIR/finance-app"
...
IMAGE_NAME="${IMAGE_NAME:-${REGISTRY_HOST}/gian/finance-frontend}"
